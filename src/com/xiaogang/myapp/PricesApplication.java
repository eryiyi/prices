 ...
 * 类的功能、说明写在此处.
 */
public class PricesApplication extends Application {
    ...
    private static final String TAG = PricesApplication.class.getName();
    ...
    private static PricesApplication instance;
    // login user name
...
//            lon= location.getLongitude();
    ...
    public static PricesApplication getInstance() {
        return instance;
    }
