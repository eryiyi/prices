 ...
 * Time: 16:17
 */
public class ItemShiyongchengduAdapter extends BaseAdapter {
    private ViewHolder holder;
    private List<Chengdu> lists;
    ...
    public ItemShiyongchengduAdapter(List<Chengdu> lists, Context mContext) {
        this.lists = lists;
    ...
    public View getView(final  int position, View convertView, ViewGroup parent) {
        ...
        final Chengdu favour = lists.get(position);
        if (favour != null) {
