 ...
 * 1：从热门开始
 ...
 6：评价从高到低
 */
public class SelectSortWindow extends PopupWindow {
    private TextView  cancel;
    private ListView lstv;
    private ImageView no_goods;
    private View mMenuView;
    private ItemtypesSortAdapter adapter;
    ...
    public SelectSortWindow(final Activity context, final List<SortType> listsType) {
        super(context);
        adapter = new ItemtypesSortAdapter(listsType, context);
        ...
        lstv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view,final int i, long l) {
                Intent intent = new Intent("select_sort");
                intent.putExtra("sort", listsType.get(i).getId());
