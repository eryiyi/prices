...
import com.xiaogang.myapp.ui.LoginActivity;

public class HxMainActivity extends BaseActivity implements EMEventListener {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (ChatActivity.activityInstance != null
						...
						Toast.makeText(HxMainActivity.this, ChatActivity.activityInstance.getToChatUsername() + st10, Toast.LENGTH_SHORT)
								.show();
		...
		if (!HxMainActivity.this.isFinishing()) {
			...
			try {
				if (accountRemovedBuilder == null)
					accountRemovedBuilder = new android.app.AlertDialog.Builder(HxMainActivity.this);
