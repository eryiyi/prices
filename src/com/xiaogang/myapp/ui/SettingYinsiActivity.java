 ...
 */
public class SettingYinsiActivity extends BaseActivity implements View.OnClickListener{
    MyTextView2 view;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.set_yinsi_activity);
        view = (MyTextView2) findViewById(R.id.view);
        view.setText(getAssetsString(this,"4.txt"));
